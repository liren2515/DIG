...
class SMPLServer(torch.nn.Module):
    ...
    def __init__(self, param_canonical, model_path='./smpl_pytorch', gender='neutral', betas=None, v_template=None):
        super().__init__()
    ...
    def forward(self, smpl_params, absolute=False):
        ...
        output['smpl_tfs_weighted'] = smpl_output.T_weighted.clone()
        output['weights'] = smpl_output.weights.clone()
