...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self._parser.add_argument('--nepochs_interval', type=int, default=9999999999999999999999, help='# of epochs to start step decay')

        self._parser.add_argument('--lr_G', type=float, default=0.001, help='initial learning rate for G adam')
        ...
        self._parser.add_argument('--num_samp_per_scene', default=6000, type=int, help='num_sample_per_scene')
        self._parser.add_argument('--num_frame_per_scene', default=5, type=int, help='num_frame_per_scene')  
